# 🏦 Finsight - 금융 경제 지식 제공 플랫폼 메인 서버

> 사용자 맞춤형 금융 지식 제공 플랫폼 백엔드 시스템
...
> **📚 API 문서**: [docs/API.md](docs/API.md)에서 모든 REST API 엔드포인트와 실제 서버 응답 예시를 확인할 수 있습니다.
...
> **📚 전체 API 명세서**: [docs/API.md](docs/API.md) - 모든 REST API 엔드포인트와 실제 서버 응답 예시
